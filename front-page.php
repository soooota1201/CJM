<?php get_header(); ?>
      ...
      <main>
        <section class="mv">
          <figure class="goldline"><img src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/mv-line.jpg" alt="金色　線"></figure>

          <!-- swiper -->
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img class="swiper-img pc-mv" src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/top-pc-1.jpg" alt="">
                <img class="swiper-img sp-mv" src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/mv1.jpg" alt="チキン　画像"></div>
              <div class="swiper-slide">
                <img class="swiper-img pc-mv" src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/top-pc-2.jpg" alt="">
                <img class="swiper-img sp-mv" src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/mv2.jpg" alt="キンパ　画像"></div>
            </div>
            <!-- Add Arrows -->
          ...
          <figure class="goldline"><img src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/mv-line.jpg" alt=""></figure>
        </section><!-- /.mv -->
        ...
        <div class="infiniteslide">
          ...
          <ul class="infinite-list">
            <li class="infinite-item"><img src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/slide-img1.jpg" alt="チキン　画像" /></li>
            <li class="infinite-item"><img src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/slide-img2.jpg" alt="キンパ　画像" /></li>
            <li class="infinite-item"><img src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/slide-img3.jpg" alt="" /></li>
            <li class="infinite-item"><img src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/slide-img4.jpg" alt="" /></li>
            <li class="infinite-item"><img src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/slide-img1.jpg" alt="チキン　画像" /></li>
            <li class="infinite-item"><img src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/slide-img2.jpg" alt="キンパ　画像" /></li>
            <li class="infinite-item"><img src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/slide-img3.jpg" alt="" /></li>
            <li class="infinite-item"><img src="<?php echo get_template_directory_uri(); ?>/src/img/mv-line.jpg/src/img/slide-img4.jpg" alt="" /></li>
